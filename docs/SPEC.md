...
> H5 前端开发技术规范完整文档
> 本规范定义了 H5 项目开发的技术栈、工具链、编码风格与最佳实践

## 目录

- [1. 源代码管理](#1-源代码管理)
  - [1.1 Git 规范](#11-git-规范)
  - [1.2 GitLab 配置](#12-gitlab-配置)
  - [1.3 仓库策略](#13-仓库策略)
  - [1.4 分支开发工作流](#14-分支开发工作流)
- [2. HTML 规范](#2-html-规范)
- [3. CSS 规范](#3-css-规范)
  - [3.1 CSS 编码风格](#31-css-编码风格)
  - [3.2 CSS 模块化](#32-css-模块化)
  - [3.3 CSS 预处理器框架](#33-css-预处理器框架)
- [4. ECMAScript 规范](#4-ecmascript-规范)
- [5. JavaScript 引擎与运行环境](#5-javascript-引擎与运行环境)
  - [5.1 开发环境](#51-开发环境)
  - [5.2 测试环境](#52-测试环境)
  - [5.3 生产环境](#53-生产环境)
- [6. JavaScript 风格](#6-javascript-风格)
  - [6.1 TypeScript](#61-typescript)
  - [6.2 JavaScript + JSDoc](#62-javascript--jsdoc)
- [7. JavaScript 模块系统](#7-javascript-模块系统)
- [8. 包管理器](#8-包管理器)
  - [8.1 Corepack 版本管理](#81-corepack-版本管理)
  - [8.2 包管理器配置](#82-包管理器配置)
  - [8.3 Registry 配置](#83-registry-配置)
  - [8.4 package.json 规范](#84-packagejson-规范)
- [9. 构建工具链](#9-构建工具链)
  - [9.1 EditorConfig](#91-editorconfig)
  - [9.2 Linters](#92-linters)
  - [9.3 Formatters](#93-formatters)
  - [9.4 编译器/转译器](#94-编译器转译器)
  - [9.5 模块打包器](#95-模块打包器)
- [10. 前端框架](#10-前端框架)
  - [10.1 Vue 2 规范](#101-vue-2-规范)
  - [10.2 Vue 风格指南](#102-vue-风格指南)
- [11. 路由管理](#11-路由管理)
- [12. 状态管理](#12-状态管理)
- [13. 生态系统与库](#13-生态系统与库)
...
用户组件名应始终为多词，但根 App 组件除外。这可以防止与现有和未来的 HTML 元素冲突，因为所有 HTML 元素都是单个单词。
...
本规范是 H5 前端开发的技术基线，旨在统一团队的技术选型、编码风格与工程实践。随着技术演进和项目需求变化，规范将持续更新。

所有团队成员 `MUST` 遵循本规范；如需调整，`MUST` 通过团队评审并更新文档。
